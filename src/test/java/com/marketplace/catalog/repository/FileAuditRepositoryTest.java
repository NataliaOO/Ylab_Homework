...
class FileAuditRepositoryTest {
    ...
    void saveAndReload_shouldPersistAuditRecords() {
        ...
        repo1.save(new AuditRecord(LocalDateTime.now(), ADMIN_LOGIN, "LOGIN", "User logged in"));
        repo1.save(new AuditRecord(LocalDateTime.now(), ADMIN_LOGIN, "CREATE_PRODUCT", "id=1"));
