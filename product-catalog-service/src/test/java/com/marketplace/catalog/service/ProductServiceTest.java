...
import com.marketplace.catalog.repository.impl.InMemoryProductRepository;
...
import static com.marketplace.catalog.TestConstants.ADMIN_LOGIN;
...
class ProductServiceTest {
    ...
    void setUp() {
        ...
        metricsService = new InMemoryMetrics();
    ...
    void createProduct_shouldIncreaseCountAndWriteMetrics() {
        ...
        Product created = productService.createProduct(p, ADMIN_LOGIN);
    ...
    void updateProduct_shouldModifyExistingProduct() {
        ...
        Optional<Product> result = productService.updateProduct(first.getId(), updated, ADMIN_LOGIN);
    ...
    void deleteProduct_shouldRemoveProductAndIncreaseMetrics() {
        ...
        boolean deleted = productService.deleteProduct(first.getId(), ADMIN_LOGIN);
    ...
    void deleteProduct_nonExistingId_shouldReturnFalse() {
        boolean deleted = productService.deleteProduct(999L, ADMIN_LOGIN);
        assertFalse(deleted);
