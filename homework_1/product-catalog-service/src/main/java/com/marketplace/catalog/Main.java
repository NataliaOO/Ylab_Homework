...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ProductService productService = new ProductService(productRepository, auditRepository, metricsService);
        AuditService auditService = new AuditService(auditRepository);

        ConsoleApp app = new ConsoleApp(authService, productService, auditService, metricsService);
        app.run();
    }
}
